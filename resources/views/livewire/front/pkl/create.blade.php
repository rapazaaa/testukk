<style>
  /* Ubah warna icon calendar di input type date */
  input[type="date"]::-webkit-calendar-picker-indicator {
    filter: invert(1);
    /* Membalik warna agar terlihat hitam di background putih */
  }
</style>
...
<div class="fixed inset-0 z-10 overflow-y-auto ease-out duration-400">
  <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
    ...
    <div
      ...
      <div class='py-4 px-4'>n
        <h2 class='font-semibold text-gray-800'>Lapor PKL</h2>
        <p class="text-sm text-gray-500 mt-1">{{ $siswa_login->nama }}</p>
        ...
        <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
          <div>
            ...
            <fieldset class="border border-gray-300 rounded-md p-4">
              ...
              <div class="mb-4">
                ...
                <select wire:model="siswaId" class="text-black pr-10">
            ...
            <fieldset class="border border-gray-300 rounded-md p-4">
              ...
              <div class="mb-4">
                <select wire:model="industriId" class="text-black pr-10">
          ...
          @endforeach
            ...
            <fieldset class="border border-gray-300 rounded-md p-4">
              ...
              <div class="mb-4">
                <select wire:model="guruId" class="text-black pr-10">
          ...
          @endforeach
            ...
            <fieldset class="border border-gray-300 rounded-md p-4">
              ...
              <div class="mb-4">
                ...
                <input wire:model="mulai" type="date" id="start-date" name="start-date"
                  class="mt-1 p-2 border rounded-md w-full focus:ring focus:ring-blue-300 focus:outline-none text-black">
              ...
              <div class="mb-4">
                ...
                <input wire:model="selesai" type="date" id="start-date" name="end-date"
                  class="mt-1 p-2 border rounded-md w-full focus:ring focus:ring-blue-300 focus:outline-none text-black">
